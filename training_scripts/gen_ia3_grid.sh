...
export BASE_DIR="/tmp/ia3-grid-2/"
export SEED=31337
...
export PROMPT="portrait photo of ($INSTANCE: 1.2), fisherman, trucker hat, 1992, film grain, faded, kodachrome"
...
# if running on 11gb 2080 ti, include above:
#      --vae_slices 16 \
